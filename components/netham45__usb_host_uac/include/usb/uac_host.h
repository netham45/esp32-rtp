...
/**
 * @brief USB Audio specification version identifiers
 */
typedef enum {
    UAC_VERSION_1_0 = 0x0100,        /*!< USB Audio Class 1.0 */
    UAC_VERSION_2_0 = 0x0200,        /*!< USB Audio Class 2.0 */
} uac_spec_version_t;
...
typedef struct {
    ...
    uint16_t spec_version;                           /*!< UAC specification version for this alternate */
    uint8_t format_type;                             /*!< Audio format type (Type I/II/III) */
    uint32_t format_flags;                           /*!< wFormatTag (UAC1) or bmFormats (UAC2) */
    uint8_t subslot_size;                            /*!< Bytes per audio subslot */
    uint32_t channel_config;                         /*!< Channel map bitmap when provided */
